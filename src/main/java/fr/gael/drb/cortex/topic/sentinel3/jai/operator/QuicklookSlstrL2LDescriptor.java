 ...
 */
public class QuicklookSlstrL2LDescriptor extends OperationDescriptorImpl
{
    public final static String OPERATION_NAME = "QuicklookSlstrL2L";
    ...
    protected static String[][] resources =
            {
                    ...
                    { "Description", "Performs the rendering of S3 SLSTR L2 Land dataset." },
     ...
     */
    private static String[] paramNames = { "pixels_correction", "flags", "exceptions" };

    /**
     * The parameter class types for the "QuicklookOlci" operation.
     */
    private static Class<?>[] paramClasses = { Common.PixelCorrection[].class, int[][].class, int[][].class };
     ...
     */
    public QuicklookSlstrL2LDescriptor()
    {
     ...
     */
    public static RenderedOp create(Common.PixelCorrection[]pixels_correction, int[][] flags, int[][] exceptions,
                                    RenderingHints hints, RenderedImage... sources)
    {
      ...
      /*To Be remove */
        ...
        pb.setParameter(paramNames[1], exceptions);
